            ...
            if (mysqli_num_rows($result) == 1) {
                ...
                if (password_verify($password, $row['password'])) {
                    if ($row["role"] == 'admin') {
                        ...
                        $_SESSION['users_id'] = $row['id'];
                        redirect('student/index.php', 'Logged In Successfully');
                        ...
                        $_SESSION['users_id'] = $row['id'];
                        redirect('teacher/index.php', 'Logged In Successfully');
                    } else {
                        if ($row['is_ban'] == 1) {
                            redirect('login.php', 'Your account has been. Please contact admin');
                        }
