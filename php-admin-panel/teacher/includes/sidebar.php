<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="class.php">
            ...
            <span class="nav-link-text ms-1">Class & subject</span>
          </a>
        </li>
    ...
    <div class="sidenav-footer mx-3 ">
      ...
      <a class="btn bg-gradient-primary mt-3 w-100" onclick="return confirm('Are you sure you want to logout?')" href="../logout.php">Logout</a>
    </div>
  </aside>