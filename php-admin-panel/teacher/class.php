            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $teacher_info = getTeacherInfo($_SESSION['users_id']);
                            // ndd($teacher_info);
                            $courses = getAllCourseOfTeacher($teacher_info['data']['id']);
                            // ndd($courses);
                            ...
                            if (mysqli_num_rows($courses)) {
                                foreach ($courses as $index => $courseItem) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="viewclass.php?id=<?= $courseItem['id']; ?>" class="btn btn-link">
