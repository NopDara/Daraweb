    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4>
                    Edit User
                    <a href="profile.php" class="btn btn-danger float-end">Discard</a>
                </h4>
                <div class="card-body">

                    <?= alertMessage(); ?>

                    <form action="profile-code.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select name="role" required class="form-select">
                                            ...
                                            <option value="admin" <?= $user['data']['role'] == 'admin' ? 'selected' : ''; ?>>
                                                Admin
                                            </option>
