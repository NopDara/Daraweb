                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select name="role" required class="form-control" disabled>
                                        ...
                                        <!-- Hidden input to ensure role value is sent when form is submitted -->
                                        <input type="hidden" name="role" value="<?= $user['data']['role']; ?>">
                                    </div>
                                </div>
