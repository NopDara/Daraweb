    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4>
                    User Lists
                    <a href="users-create.php" class="btn btn-primary float-end">
                                ...
                                foreach ($users as $index => $userItem) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($userItem['photo'])): ?>
                                                <div class="d-flex justify-content-center ">
                                                    <a href="usersview.php?id=<?= $userItem['id']; ?>" class="text-decoration-none">
                                        ...
                                        <td>
                                            ...
                                            <!-- <a href="usersview.php?id=<?= $userItem['id']; ?>" class="btn btn-link">
